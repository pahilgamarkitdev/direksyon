...
import firstFloor from "@/assets/buildings/ceBuilding/1.png";
import secondFloor from "@/assets/buildings/ceBuilding/2.png";

export default function CeBuildingsContent() {
  return (
