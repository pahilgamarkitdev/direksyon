...
import firstFloor from "@/assets/buildings/athleteBuilding/1.png";
import secondFloor from "@/assets/buildings/athleteBuilding/2.png";

export default function AtheleBuildingsContent() {
  return (
