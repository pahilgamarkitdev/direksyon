...
import firstFloor from "@/assets/buildings/compEBuilding/1.png";
import secondFloor from "@/assets/buildings/compEBuilding/2.png";
import thirdFloor from "@/assets/buildings/compEBuilding/3.png";

export default function CompEBuildingsContent() {
  return (
